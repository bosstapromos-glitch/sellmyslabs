...
const SOURCES = ["Google Search", "Referral", "Card Show", "Reddit", "Other"];
const STATUSES = {
          ...
          <nav style={{display:"flex",alignItems:"center",gap:8}} aria-label="Main navigation">
            ...
            {auth?(
              ...
              <div style={{display:"flex",alignItems:"center",gap:4,marginLeft:8}}>
                <input type="password" placeholder="PIN" aria-label="Admin PIN" value={pin} onChange={e=>setPin(e.target.value)}
                ...
                <button onClick={()=>{if(pin==="2024"){setAuth(true);setPage("admin");setPin("")}}}
                  style={{padding:"7px 12px",borderRadius:7,border:"none",background:"var(--gold)",color:"var(--bg)",fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"'Outfit',sans-serif"}} aria-label="Submit PIN">→</button>
              </div>
            )}
          </nav>
        </header>

        <main id="main-content" role="main" style={{maxWidth:page==="home"?1200:980,margin:"0 auto",padding:"0 24px 60px"}}>
          ...
          <footer style={{borderTop:"1px solid var(--border)",padding:"48px 28px 32px",maxWidth:1200,margin:"0 auto"}}>
            <div style={{display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr",gap:40,marginBottom:40}}>
              ...
              <div>
                ...
                <ul style={{listStyle:"none",fontSize:13,color:"var(--text2)",lineHeight:2.2}}>
                  <li><a href="#how-it-works" style={{color:"var(--text2)",textDecoration:"none",transition:"color .2s"}} onMouseEnter={e=>e.target.style.color="var(--gold)"} onMouseLeave={e=>e.target.style.color="var(--text2)"}>How It Works</a></li>
                  <li><a href="#faq" style={{color:"var(--text2)",textDecoration:"none",transition:"color .2s"}} onMouseEnter={e=>e.target.style.color="var(--gold)"} onMouseLeave={e=>e.target.style.color="var(--text2)"}>FAQ</a></li>
                  <li><a href="#get-started" style={{color:"var(--text2)",textDecoration:"none",transition:"color .2s"}} onMouseEnter={e=>e.target.style.color="var(--gold)"} onMouseLeave={e=>e.target.style.color="var(--text2)"}>Get Started</a></li>
                </ul>
              </div>
            </div>
    ...
    <div>
      ...
      <section style={{padding:"100px 0 80px",textAlign:"center",position:"relative"}} aria-label="Sell your graded cards for cash">
        ...
        <div className="au3 stats-grid" style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:2,maxWidth:680,margin:"0 auto 60px",borderRadius:16,overflow:"hidden",border:"1px solid var(--border)"}}>
          {[{n:"24hr",l:"Offer Turnaround"},{n:"7",l:"Categories Accepted"},{n:"3",l:"Grading Companies"},{n:"100%",l:"Response Rate"}].map((s,i)=>(
      ...
      {/* HOW IT WORKS */}
      <section id="how-it-works" className="au4" style={{marginBottom:72}} aria-label="How to sell your graded cards">
      ...
      <section id="faq" className="au5" style={{marginBottom:72,maxWidth:720,margin:"0 auto 72px"}} aria-label="Frequently asked questions about selling graded cards">
        <div style={{textAlign:"center",marginBottom:32}}>
      ...
      {/* LEAD CAPTURE CTA */}
      <section id="get-started" style={{marginBottom:40}} aria-label="Start selling your graded cards">
